...
void LaserRangeFinderROS::scanEvent(const rec::robotino::api2::LaserRangeFinderReadings &scan)
{
	...
	//laser_scan_msg_.time_increment = scan.time_increment/1000000000.0; //Behebung eines Fehlers mit dem Lidar
	//laser_scan_msg_.scan_time = scan.scan_time/1000000000.0;
